            ...
            <div className="grid md:grid-cols-2 gap-0 max-w-4xl w-full mx-auto rounded-xl shadow-2xl overflow-hidden border border-white/20">
                ...
                <Card className="w-full h-full bg-white/30 backdrop-blur-lg rounded-none md:rounded-r-xl border-none">
                    <CardHeader className="text-center pt-4">
                        <CardTitle className="text-3xl font-bold text-foreground">Lecturer Login</CardTitle>
                        <CardDescription className="text-muted-foreground">Welcome! Manage your courses and students.</CardDescription>
                    </CardHeader>
                    <CardContent className="px-8 pb-4">
                        <form className="space-y-2" onSubmit={handleLogin}>
                            ...
                            <div className="space-y-1">
                                ...
                                <Input id="email" type="email" placeholder="lecturer@example.com" className="bg-white/80" value={email} onChange={(e) => setEmail(e.target.value)} />
                            </div>
                            <div className="space-y-1">
